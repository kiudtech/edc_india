        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6">
          <motion.div variants={fadeUp} initial="hidden" animate="visible">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Link to="/join" className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 px-8 py-3.5 text-sm font-bold text-white shadow-lg shadow-cyan-500/25 transition hover:scale-105 hover:shadow-cyan-500/40">
