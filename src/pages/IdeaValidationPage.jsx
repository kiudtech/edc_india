                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    <label className="flex cursor-pointer items-start gap-3">
                      ...
                      <span className="text-xs text-slate-500">I agree to the <a href="/terms" target="_blank" className="font-semibold text-purple-600 hover:underline">Terms & Conditions</a> and <span className="font-semibold text-purple-600">Privacy Policy</span> of EDC India.</span>
                    </label>
                  </div>
                </div>
