    ...
    <div className="bg-white min-h-screen text-slate-800">
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <Section number="5" title="Refund Policy">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>Duplicate payment due to a technical error (full refund within 90 working days)</li>
          ...
          <p><strong>Refund Process:</strong> To request a refund, email <a href="mailto:enquiry@edcindia.in" className="text-blue-600 hover:underline">enquiry@edcindia.in</a> with your registered email, transaction ID, and reason. Approved refunds will be processed within 90 working days to the original payment method.</p>
